...
export let startEpisode : NextStoryAndPassagesArr = [
    ...
    [
        ...
        [
            ...
            afterStory: `부모님이 살아계시기를 기대하진 않는다. 미사일이 직격 했던 서울은 말 그대로 폐허. 사람이 살 수 없는 곳이 됐다고 들었다. 그런데 왠지 모르게 서울이 아른거린다. 추억이 담긴 도시의 잔해라도 보고 싶은 마음일까? 아니면 갈수록 사람이 몰려드는 탓에 위험해지는 부산을 벗어나려는 현실적인 판단일까? 뭐가 됐든 빠른 시일 내에 이곳을 뜨고 싶다. 
협력자에게 이 얘기를 했더니 날 안타깝게 쳐다보면서 충고를 건넸다. '바깥은 이곳과 비교도 안 될 정도로 위험한 무법지대다. 서울은커녕 경상도에 발 디디기도 전에 죽을 수 있다. 떠나기 전에 이곳의 미약한 치안이 당신을 얼마나 보호해 주었는지 감사해라. 그리고 겨울이 오고 있으니 발걸음을 서둘러라. 건투를 빈다.'`,
            status1: "",
            status1Num: 0,
            status2: "",
            status2Num: 0,
